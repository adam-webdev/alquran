...
const Home = () => {
  ...
  useEffect(() => {
    const getByIdKota = async () => {
      ...
      try {
        const kota2 = await fetch(
          `${baseUrl}/sholat/jadwal/${idKota}/${years}/${month}/${date}`
        );
  ...
  return (
    <>
      ...
      <WrappHome>
          ...
          <WrappKota>
            {loading ? (
              ...
              byKota && (
                <>
                  <CardWaktu>
                    <NamaWatku>Imsak</NamaWatku>
                    <Jam>{byKota.jadwal.imsak}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Subuh</NamaWatku>
                    <Jam>{byKota.jadwal.subuh}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Dhuha</NamaWatku>
                    <Jam>{byKota.jadwal.dhuha}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Dzuhur</NamaWatku>
                    <Jam>{byKota.jadwal.dzuhur}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Ashar</NamaWatku>
                    <Jam>{byKota.jadwal.ashar}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Maghrib</NamaWatku>
                    <Jam>{byKota.jadwal.maghrib}</Jam>
                  </CardWaktu>
                  <CardWaktu>
                    <NamaWatku>Isya</NamaWatku>
                    <Jam>{byKota.jadwal.isya}</Jam>
                  </CardWaktu>
                </>
              )
            )}
        ...
        <Footer>adamdwimaulana2605@gmail.com</Footer>
      </WrappHome>
    </>
  );
};
